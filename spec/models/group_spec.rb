...
# RSpec.describe Group, type: :model do
  ...
  #     @join = create(:join)
  #     expect{ @join.group.destroy }.to change{ Join.count }.by(-1)
  #   end

  #   it 'groupを削除すると、groupが作成したfavoritesも削除されること' do
  #     @favorite = create(:favorite)
  #     expect{ @favorite.group.destroy }.to change{ Favorite.count }.by(-1)
  #   end

  #   it 'groupを削除すると、groupが作成したeventsも削除されること' do
  #     @event = create(:event)
  #     expect{ @event.group.destroy }.to change{ Event.count }.by(-1)
  #   end
  # end
